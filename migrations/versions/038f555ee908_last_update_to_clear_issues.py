...
Revision ID: 038f555ee908
Revises: 5e3ebe16422c
Create Date: 2025-08-21 13:34:59.761539
...
revision: str = '038f555ee908'
down_revision: Union[str, Sequence[str], None] = '5e3ebe16422c'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('purchase_order_lines', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(None, 'purchase_orders', ['order_id'], ['id'])
