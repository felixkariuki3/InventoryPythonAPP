...
from backend.models.sales import Invoice, InvoiceLine
from backend.schemas.sales import (
    InvoiceCreate, InvoiceUpdate, InvoiceLineCreate
)
...
# ---- Invoice Line CRUD ----
def add_invoice_line(db: Session, invoice_id: int, line: InvoiceLineCreate):
    db_line = InvoiceLine(
